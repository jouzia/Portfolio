...
export const CertificateVault = () => {
  ...
  const [selectedCert, setSelectedCert] = useState(null); // Track certificate for modal preview
  ...
  const placeholders = [
    ...
    { 
      ...
      issuer: 'Adobe', 
      date: '2024-09', 
      pdf_url: 'https://drive.google.com/file/d/10o3ceaHY22LUlch0RMdy4Hnz19klIjz9/view?usp=drive_link' 
    }
  ];

  /* LEFTOVER UNASSIGNED DRIVE LINKS FOR YOUR REFERENCE:
    - https://drive.google.com/file/d/1v0s4acONM_eOz4iiFnR8NGJzrkyKH2Yz/view?usp=drive_link
    - https://drive.google.com/file/d/1YCweLqNlMQlEowZtHc7qQoRbjGc7uPLf/view?usp=drive_link
    - https://drive.google.com/file/d/195Csr8Ma3im3fdqi2S0sIoqnn1Pcs6uC/view?usp=drive_link
    - https://drive.google.com/file/d/1IZH_FpzNzAuVu46ZoUBQn3f_SXCSpym2/view?usp=drive_link
    - https://drive.google.com/file/d/1wRrEc223q5iOwgu450KVFJOs3xxE-qH0/view?usp=drive_link
    - https://drive.google.com/file/d/1iLX8zYAFIW1pAyS1g91HIq63SMGHpBWb/view?usp=drive_link
    - https://drive.google.com/file/d/1ZhW1I5DOILFRWaft4rYDdQq-CjgvgBgt/view?usp=drive_link
    - https://drive.google.com/file/d/1wmO19fBSfKB7NZ5hxsYe-4fxHWowp0sB/view?usp=drive_link
  */
  ...
  // Convert default Google Drive sharing URLs into responsive embedded frames
  ...
  return (
    <div style={{ width: '100%', position: 'relative' }}>
                  ...
                  {c.pdf_url && c.pdf_url !== '#' ? (
                    <button
                      ...
                      style={{
                        fontSize: '0.7rem',
                        fontWeight: '600',
                        color: 'var(--accent-primary, #7c6df2)',
                        background: 'none',
                        border: 'none',
                        cursor: 'pointer',
      ...
      {/* ULTRA-PREMIUM MINIMALIST GLASSMORPHISM MODAL FOR DEEP EMBED REVIEWS */}
      <AnimatePresence>
        {selectedCert && (
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  <h4 style={{ fontSize: '1.05rem', fontWeight: '600', color: '#fff', marginBottom: '2px' }}>
                    {selectedCert.title}
                  </h4>
                  <p style={{ fontSize: '0.8rem', color: 'rgba(255, 255, 255, 0.5)' }}>
                    {selectedCert.issuer} — {formatDate(selectedCert.date)}
                  </p>
                </div>
              ...
              <div style={{ 
                ...
                {selectedCert.pdf_url.includes('drive.google.com') ? (
                  <iframe 
                    src={getDrivePreviewUrl(selectedCert.pdf_url)} 
                    width="100%" 
                    height="100%" 
                    frameBorder="0" 
                    allow="autoplay"
                  ...
                  <div style={{ 
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem' }}>
                      This credential is verified directly on an external platform hub.
                    </p>
                    <a 
                      href={selectedCert.pdf_url} 
                      target="_blank" 
                      ...
                      style={{
                        padding: '8px 16px',
                        background: 'var(--accent-primary, #7c6df2)',
                        color: '#fff',
                        borderRadius: '8px',
                        textDecoration: 'none',
                        fontSize: '0.8rem',
