      ...
      <div className="glass" style={{ width: '380px', padding: '2.5rem', textAlign: 'center' }}>
        ...
        {isMockSupabase && (
          <div style={{
            ...
            fontSize: '0.8rem', color: '#4fd1c5', textAlign: 'left', lineHeight: '1.4'
          }}>
            <strong>Mock Mode Active:</strong> Log in with:
            <div style={{ marginTop: '4px', fontFamily: 'var(--font-mono)', fontSize: '0.72rem' }}>
